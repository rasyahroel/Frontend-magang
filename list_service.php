            ...
            <div>
                <ul class="list pe-4">
                    <li class="p-4 my-3 bg-yellowalt">
                        <h4><a href="http://localhost/MA_BO/detail_service.php" class="text-dark">Judul service</a></h4>
                        <p>Progres</p>
                        <h5>Desipsi</h5>
                        <p class="ms-4">Ini berisi deskripsi singkat tentang service yang dilakukan maximal 20 kata <a class="text-dark" href="http://localhost/MA_BO/detail_service.php"><strong>Lihat detail...</strong></a></p>
                    </li>
                    <li class="p-4 my-3 bg-yellowalt">
                        <h4><a href="http://localhost/MA_BO/detail_service.php" class="text-dark">Judul service</a></h4>
                        <p>Progres</p>
            ...
            <div>
                <ul class="list-service pe-4">
                    ...
                    <li class="p-4 my-3 bg-yellowalt">
                        ...
                        <p>Progres</p>
                        <h5>Desipsi</h5>
                        <p class="mb-5">Ini berisi deskripsi singkat tentang service yang dilakukan maximal 20 kata <a class="text-dark" href="http://localhost/MA_BO/detail_service.php"><strong>Lihat detail...</strong></a></p>
                    </li>
                </ul>
            </div>
        </div>
